// import { Button, Box, TablePagination, useTheme } from "@mui/material";
...
//     <Box>
//       <SnackbarProvider />
//       <Paper sx={{ width: "80%",m:'auto', overflow: "hidden" ,mt:1 }}>
...
//       <Button sx={{border:`1px solid ${theme.colorSchemes.dark.palette.primary.main}`,borderRadius:12,mt:1}} onClick={()=>{}}>Add Trainer</Button>
//       </Link>
//     </Box>
//   );
// }
...
export default function AdminTrainers() {
  ...
  async function fetchTrainers() {
    try {
      const res = await axios.get(
        "http://localhost:8000/admin/trainers",
        header
      );
  ...
  async function handleDelete(id) {
    try {
      await axios.delete(
        `http://localhost:8000/admin/deleteTrainer/${id}`,
        header
      );
